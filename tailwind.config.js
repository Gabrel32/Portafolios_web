  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        "menu-slide-reverse":
          "menuSlideReverse 0.3s cubic-bezier(0.4, 0, 0.2, 1) forwards",
      ...
      boxShadow: {
        "custom-light":
          "0px 4px 6px rgba(0, 0, 0, 0.05), 0px 1px 3px rgba(0, 0, 0, 0.03)",
        "custom-dark":
          "1px 4px 6px rgba(255, 255, 255, 0.1), 0px 1px 3px rgba(255, 255, 255, 0.06)",
