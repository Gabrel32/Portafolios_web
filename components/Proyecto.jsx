...
const blurDataURL =
  "data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHZpZXdCb3g9IjAgMCA4IDgiPjxwYXRoIGZpbGw9IiNjY2MiIGQ9Ik0wIDBoOHY4SDB6Ii8+PC9zdmc+";
          ...
          {tech.length > 0 && (
            <div className="flex flex-wrap gap-2 mb-4">
              {tech.map((t, i) => (
                <span
                  key={i}
                  className="px-2 py-1 text-xs font-medium rounded-lg bg-tech-badge text-tech-text"
                >
                  {t}
                </span>
              ))}
