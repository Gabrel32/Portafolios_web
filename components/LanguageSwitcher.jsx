  ...
  return (
    <div className="relative" ref={menuRef}>
      ...
      <button
        ...
        type="button"
        className="relative flex items-center justify-center px-1 py-2 rounded-lg gap-1 text-lg md:text-xl transition-all duration-200 ease-out hover:scale-105 active:scale-95 text-colorLetters hover:text-custom-brown dark:text-whiteSnow dark:hover:text-custom-brown"
                ...
                className={`w-full text-sm p-2 rounded-md flex items-center justify-between
                  transition-all duration-200 ease-out hover:scale-105 active:scale-95 ${
                    currentLanguage === lang.id
                      ...
                      : "text-gray-600 hover:text-custom-brown dark:text-gray-400 dark:hover:text-custom-brown"
                  }`}
              >
